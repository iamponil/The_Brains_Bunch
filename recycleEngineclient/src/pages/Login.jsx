            ...
            <MainContent>
              ...
              <FormContainer>
                <SocialButtonsContainer>
                  <SocialButton onClick={google} style={{cursor:"pointer"}}>
                    <img src={Google} alt="" className="icon"  style={{width:'40px'}}/>
                    <div className="text">Sign In With Google</div>
                  </SocialButton>

                  <SocialButton onClick={github} style={{cursor:"pointer"}}>
                    <img src={Github} alt="" className="icon" style={{width:'40px'}}/>

                    <div className="text">Sign In With Github</div>
                  </SocialButton>
                  <SocialButton onClick={linkedin} style={{cursor:"pointer"}}>
                    <img src={Linkedin} alt="" className="icon" style={{width:'40px'}} />
