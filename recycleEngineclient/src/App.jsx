...
import BlogComponent from 'pages/Blogs/BlogComponent.jsx';
import IndexBlog from 'pages/Blogs/post.jsx';
...
import Analytics from 'components/cards/analytics.jsx';
    ...
    <BrowserRouter>
      <div>
        <Routes>
          ...
          <Route path="/Analytics/:titre" element={<Analytics />} />
          ...
          <Route path="/index" element={<IndexBlog />} />
