...
export default ({ roundedHeaderButton }) => {
  ...
  const handleAnalytics = (e) => {
    e.preventDefault();
    window.location.href = `/Analytics/${projects.title}`;
  };
  useEffect(() => {
      ...
      <Container>
        <ContentWithPaddingXl>
          <Column>
            ...
            >
              {' '}
              <BsEyeFill style={{ marginRight: '20px' }} /> Preview
            </button>

            <FAQSContainer style={{ width: '800px' }}>
              <Div onClick={handlebacis} className="group">
                <Paragraph tw="font-bold text-primary-500">Basics</Paragraph>
                <p>
                  Name your project, upload an image or video, and establish
                  your campaign details.
                </p>
              </Div>
              <Div onClick={handleAnalytics} className="group">
                <Paragraph tw="font-bold text-primary-500">Analytics</Paragraph>
                <p>
                  Predict the waste in the upcoming year and pick best subject
                  for yourself.
                </p>
              </Div>
              <Div className="group">
                <Paragraph tw="font-bold text-primary-500">Rewards</Paragraph>
                <p>Set your rewards and shipping costs.</p>
              </Div>

              <Div className="group">
                <Paragraph tw="font-bold text-primary-500">Payment</Paragraph>
                <p>Verify details and link a bank account.</p>
              </Div>
            </FAQSContainer>
          </Column>
        </ContentWithPaddingXl>
