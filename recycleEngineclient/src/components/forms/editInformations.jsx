...
const Content = tw.div`max-w-screen-2xl  py-20 lg:py-24`;

const FormContainer = styled.div`
  ${tw`p-10 sm:p-12 md:p-16 bg-purple-100  opacity-100 text-purple-500 rounded-lg `}
  form {
    ${tw`mt-4`}
  }
  h2 {
        ...
        <FormContainer enctype="multipart/form-data" onSubmit={handleSubmit}>
          <div tw="mx-auto max-w-4xl">
            ...
            <form action="#">
                ...
                <Column>
                  ...
                  >
                    {previewSrc ? (
                      ...
                      <div>
                      <img src="https://bootdey.com/img/Content/avatar/avatar7.png" class="avatar" style={{height:"220px"}}alt="avatar"/>
              ...
              {successMessage && <div  style={{ backgroundColor: '#ca97ca', borderColor: '#c3e6cb', color: '#800080', padding: '1rem' ,
