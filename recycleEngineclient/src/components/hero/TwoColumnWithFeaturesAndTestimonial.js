...
export default ({
  heading = "Recycle Engine",
  description = " Recycle Engine is a crowdfunding platform that allows creators to raise funds for their creative projects through a campaign.",
  ...
  buttonRounded = true,
  features = ["We have now launched operations in Africa.", "Premium Internet Backbone", "99.99% Uptime SLA"],
  testimonial = {
    quote: "Success in technology is not just about having a great idea, it's about having the discipline, determination, and creativity to bring that idea to life.",
    customerName: " Satya Nadella",
    customerCompany: "CEO of Microsoft."
  }
}) => {
  ...
  const navLinks = [
    <NavLinks key={1}>
      ...
      <NavLink href="/#">Start a project</NavLink>
    ...
    <>
      ...
      <Container>
        <ContentWithVerticalPadding>
          <Row>
            <TextColumn>
              <Heading>Hire the best</Heading>
            <Headings>
            <SlantedBackground>Recycle Engine.</SlantedBackground></Headings>
